...
- Mainly responsible for the design and development of economic subsystems, aggregate and analyze business log data and provide API query interfaces, so that operators can view analysis indicators on the web and formulate strategies to optimize products.
...
-	As the first product of the company to enter the blockchain game, rowing game has transferred 50+ selected personnel to set up a new department. As one of the 7 background engineers, I am mainly responsible for auction services and blind box services, infrastructure development and Optimization, and DevOps for the entire project.
...
-	As an important part of the company's main revenue of chess and card games - robot AI, its performance affects the player's experience and the company's revenue. I was guided and studied by the team leader, and was mainly responsible for the development and optimization of robot AI algorithms in overseas mahjong projects.
